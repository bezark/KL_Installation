...
class SayPlatformBase {
   ...
   * @param {string|null} customArgs Chris's back door to select a custom audio device.
   * @param {Function|null} callback A callback of type function(err) to return.
   */
  speak (text, voice, speed, customArgs, callback) {
    ...
    let {command, args, pipedData, options} = this.buildSpeakCommand({text, voice, speed, customArgs});
